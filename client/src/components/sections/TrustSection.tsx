  ...
  return (
    ...
    >
      <div className="relative container max-w-6xl mx-auto px-4">
        <div className="trust-reveal text-center mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {logos.map((sector, i) => (
              <div
                key={i}
                className="px-5 py-2.5 rounded-full border border-gray-200 text-gray-600 text-sm hover:border-[#BA1414]/30 hover:text-[#BA1414] transition-all duration-300"
              >
                {sector}
              </div>
            ))}
        ...
        {/* Testimonial */}
        <div className="trust-reveal max-w-3xl mx-auto text-center mt-16 p-8 md:p-12 rounded-lg border border-gray-100 shadow-sm">
